...
public class DlgResignFromOwn2 extends TemplateSearcher {
    private final Mat result = new Mat();

    public DlgResignFromOwn2() throws IOException {
        super("resignFromOwn2Unpressed", ".png");
    }
