...
public class MatchView extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        paintChequersOnBar(g2, boardx, boardy, unit, own, chequerColors);
    ...
    private void paintChequersOnBar(Graphics2D g, int boardx, int boardy, int unit, int own, Color[] chequerColors) {
